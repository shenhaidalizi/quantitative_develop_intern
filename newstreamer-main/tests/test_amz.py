...
# 读写分离（与 CLI 一致）
REDIS_WRITE_USERNAME = os.getenv("REDIS_WRITE_USERNAME") or os.getenv("REDIS_USERNAME")
REDIS_WRITE_PASSWORD = os.getenv("REDIS_WRITE_PASSWORD") or os.getenv("REDIS_PASSWORD")
REDIS_READ_USERNAME = os.getenv("REDIS_READ_USERNAME") or os.getenv("REDIS_USERNAME")
REDIS_READ_PASSWORD = os.getenv("REDIS_READ_PASSWORD") or os.getenv("REDIS_PASSWORD")
...
def main() -> None:
    ...
    key = "hc"  # 实际键为 prefix + "hc"，期望为 "teamPublic:hc"
